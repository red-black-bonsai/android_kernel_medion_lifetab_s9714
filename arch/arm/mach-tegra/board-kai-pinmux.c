...
static __initdata struct tegra_pingroup_config kai_pinmux_common[] = {
   ...
   DEFAULT_PINMUX(CRT_VSYNC,       RSVD1,           PULL_UP,    NORMAL,     INPUT), /* SIM card detect pin */
#endif
	...
	/* GPIO_PH5 TS_RESET */
	DEFAULT_PINMUX(GMI_AD13,        NAND,           NORMAL,    NORMAL,   OUTPUT/*INPUT*/),  /*20130311, JimmySu modify for touch reset */
