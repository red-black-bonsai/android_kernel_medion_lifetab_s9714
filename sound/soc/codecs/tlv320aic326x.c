...
//&*&*&*HY1_1201008: Modify code for Dolby requirement test.			
			snd_soc_write(codec, HPR_VOL, 0xBD);   
		}		
	}	
...
//&*&*&*HY2_1201008: Modify code for Dolby requirement test.	
	}
...
//&*&*&*BC1_121203: reduce the pop noise when user uses the headset microphone to record
			mdelay(100);
//&*&*&*BC2_121203: reduce the pop noise when user uses the headset microphone to record		
			break;
		default:
			printk("%s:unknown arguement\n", __func__);
			break;
...
//&*&*&*HY1_121021: remove kernel DRC firmware
	apply_patch_d_b1(codec, patch_speaker, ARRAY_SIZE(patch_speaker));
	//apply_patch_d_b1(codec, patch_speaker_drc, ARRAY_SIZE(patch_speaker_drc));
//&*&*&*HY2_121021: remove kernel DRC firmware		
	aic3262_change_book(codec, 0x0);
//&*&*&*BC2_120530: add audio srs function
