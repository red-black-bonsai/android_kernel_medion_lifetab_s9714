					...
					struct resource *fb_mem)
{
	...
	if (dc->mode.pclk > 1000) {
		...
		mode->pclk = 65000000; /*20121120, JimmySu add workaround for pass CTS DisplayRefreshRateTest*/
		...
		mode->pclk = 68900000; /*20121120, JimmySu add workaround for pass CTS DisplayRefreshRateTest*/
	}
