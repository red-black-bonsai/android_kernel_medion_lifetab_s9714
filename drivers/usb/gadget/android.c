...
//&*&*&*SJ1_20120806, add string description of the ADB interface.
	[STRING_INTERFACE_IDX].s = "MEDION Android Composite USB Interface",
//&*&*&*SJ2_20120806
	{  }			/* end of list */
};
...
//&*&*&*SJ1_20120730, modify for A2110 
	config->fsg.luns[0].cdrom = 1;
	config->fsg.luns[0].ro = 1;
	config->fsg.vendor_name = "MEDION";
	config->fsg.product_name = "File-CD Gadget";
//&*&*&*SJ2_20120730, modify for A2110
